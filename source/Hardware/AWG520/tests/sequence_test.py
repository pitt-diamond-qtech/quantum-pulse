...
def make_seq():
    ...
    seq = [['Wave', '900', '1400', 'DataIQ', wfmdir/'IQdata.txt']]
    ...
    newparams = {'amplitude': 1000, 'pulsewidth': 50, 'SB freq': 0, 'IQ scale factor': 1.0, 'phase': 0.0, 'skew phase':0.0, 'num pulses': 1}
...
def make_seq_list():
    ...
    seq = [['Wave', '0', '1000','SquareI']]
    newparams = {'amplitude': 100, 'pulsewidth': 50, 'SB freq': 10, 'IQ scale factor': 1.0, 'phase': 0.0,
                 'skew phase': 0.0, 'num pulses': 1}
    newscanparams = {'type':'time','start': 0, 'stepsize': 100, 'steps': 5}
